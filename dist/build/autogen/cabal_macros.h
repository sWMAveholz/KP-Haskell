...
/* package haskell-start-0.1.0.0 */
#ifndef VERSION_haskell_start
#define VERSION_haskell_start "0.1.0.0"
#endif /* VERSION_haskell_start */
#ifndef MIN_VERSION_haskell_start
#define MIN_VERSION_haskell_start(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_start */
...
#define CURRENT_PACKAGE_KEY "haskell-start-0.1.0.0-AOIXUyE1gRPF8rv34JWkI9"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-start-0.1.0.0-AOIXUyE1gRPF8rv34JWkI9"
